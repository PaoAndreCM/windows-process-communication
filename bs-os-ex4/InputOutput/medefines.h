...
//              defines for constants used in ME-iDS
//==============================================================================
...
/*==================================================================
  Defines for meOpen function
  ================================================================*/

#define ME_OPEN_NO_FLAGS                        0x0

/*==================================================================
  Defines for meClose function
  ================================================================*/

#define ME_CLOSE_NO_FLAGS                       0x0

/*==================================================================
  Defines for meLockDriver function
  ================================================================*/

#define ME_LOCK_DRIVER_NO_FLAGS                 0x0

/*==================================================================
  Defines for meLockDevice function
  ================================================================*/

#define ME_LOCK_DEVICE_NO_FLAGS                 0x0

/*==================================================================
  Defines for meLockSubdevice function
  ================================================================*/

#define ME_LOCK_SUBDEVICE_NO_FLAGS              0x0

/*==================================================================
  Defines common to meErrorGetLastMessage and meErrorGetMessage
  ================================================================*/
...
#define ME_ERROR_GET_LAST_NO_FLAGS				0x0
#define ME_ERROR_GET_LAST_CLEAR					0x1

/*==================================================================
  Defines common to io functions
  ================================================================*/
  
#define ME_REF_NONE                             0x0
...
#define ME_TRIG_CHAN_NONE                       ME_VALUE_NOT_USED
#define ME_TRIG_CHAN_DEFAULT                    0x00070001
#define ME_TRIG_CHAN_SYNCHRONOUS                0x00070002

#define ME_TRIG_TYPE_NONE                       ME_VALUE_NOT_USED
...
#define ME_TRIG_TYPE_PATTERN                    0x00080008	// These two defines are the same 
#define ME_TRIG_TYPE_PATTERN_MATCH              0x00080008	// to preserve compatibility
#define ME_TRIG_TYPE_TIMER                      0x00080009
#define ME_TRIG_TYPE_COUNT                      0x0008000A
#define ME_TRIG_TYPE_FOLLOW                     0x0008000B
#define ME_TRIG_TYPE_PATTERN_NO_MATCH           0x0008000C
#define ME_TRIG_TYPE_EXT_DIGITAL_OR_COUNT       0x0008000D
#define ME_TRIG_TYPE_PATTERN_MATCH_OR_COUNT		0x0008000E
#define ME_TRIG_TYPE_PATTERN_NO_MATCH_OR_COUNT	0x0008000F

#define ME_TRIG_EDGE_NONE                       ME_VALUE_NOT_USED
...
#define ME_IRQ_SOURCE_DIO_NORMAL_TEMP           0x000B0005
#define ME_IRQ_SOURCE_DIO_CHANGE_TEMP           0x000B0006

#define ME_IRQ_EDGE_RISING                      0x000C0001
#define ME_IRQ_EDGE_FALLING                     0x000C0002
#define ME_IRQ_EDGE_ANY                         0x000C0003

#define ME_IO_IRQ_START_NO_FLAGS                0x00000000
#define ME_IO_IRQ_START_DIO_BIT                 0x00000001
#define ME_IO_IRQ_START_DIO_BYTE                0x00000002
#define ME_IO_IRQ_START_DIO_WORD                0x00000004
#define ME_IO_IRQ_START_DIO_DWORD               0x00000008
#define ME_IO_IRQ_START_PATTERN_FILTERING       0x00000010
#define ME_IO_IRQ_START_EXTENDED_STATUS         0x00000020
#define ME_IO_IRQ_START_USE_PROPERTIES          0x40000000

/*==================================================================
  Defines for meIOIrqWait function
  ================================================================*/

#define ME_IO_IRQ_WAIT_NO_FLAGS                 0x00000000
#define ME_IO_IRQ_WAIT_NORMAL_STATUS            0x00000001
#define ME_IO_IRQ_WAIT_EXTENDED_STATUS          0x00000002

/*==================================================================
  Defines for meIOIrqStop function
  ================================================================*/

#define ME_IO_IRQ_STOP_NO_FLAGS                 0x0
...
#define ME_IO_SET_CHANNEL_OFFSET_NO_FLAGS       0x0
...
#define ME_SINGLE_CONFIG_FIO_HIGH_IMPEDANCE     0x001E0002
#define ME_SINGLE_CONFIG_FIO_SINK               0x001E0003
#define ME_SINGLE_CONFIG_FIO_SOURCE             0x001E0004
...
#define ME_IO_SINGLE_TYPE_FO_START_LOW				0x80	
#define ME_IO_SINGLE_TYPE_FO_START_SOFT				0x100	
#define ME_IO_SINGLE_TYPE_FI_LAST_VALUE				0x200	
#define ME_IO_SINGLE_TYPE_FO_UPDATE_ONLY			0x200	
#define ME_IO_SINGLE_TYPE_FIO_TICKS_TOTAL			0x400
#define ME_IO_SINGLE_TYPE_FIO_TICKS_FIRST_PHASE		0x800
#define ME_IO_SINGLE_TYPE_FO_USE_PROPERTIES         0x40000000
...
#define ME_IO_STREAM_CONFIG_INTERNAL_COUNTER	0x80000000 
...
#define ME_IO_TIME_TO_TICKS_NO_FLAGS							0x0
...
#define ME_CAPS_DIO_NORMAL_TEMP_IRQ             0x00000400
...
#define ME_TYPE_FIO                             0x00180008
#define ME_TYPE_FO                              0x00180009
#define ME_TYPE_FI                              0x0018000A
...
#define ME_EXTENSION_TYPE_ME1001                0x001C0005
...
#define ME_PWM_START_NO_FLAGS                   0x0
#define ME_PWM_START_CONNECT_INTERNAL           0x1

#define ME_IO_PIN_VOLTAGE_LEVEL_5_VOLTS			0x0
#define ME_IO_PIN_VOLTAGE_LEVEL_3_3_VOLTS		0x1

//------------------------------------

#define ME_PROPERTY_TYPE_INVALID				0x0
#define ME_PROPERTY_TYPE_CONTAINER				0x1
#define ME_PROPERTY_TYPE_BOOL					0x2
#define ME_PROPERTY_TYPE_INT					0x3
#define ME_PROPERTY_TYPE_DOUBLE					0x4
#define ME_PROPERTY_TYPE_STRING					0x5
#define ME_PROPERTY_TYPE_DEFINE					0x6

#define ME_PROPERTY_ACCESS_READ_ONLY			0x0
#define ME_PROPERTY_ACCESS_READ_WRITE			0x1

#define ME_PROPERTY_BOOLEAN_FALSE				0x00
#define ME_PROPERTY_BOOLEAN_TRUE				0x01

#define ME_CALIBRATION_TYPE_FACTORY				0x001E0000
#define ME_CALIBRATION_TYPE_USER_1				0x001E0001
